...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "asset_id", "timestamp", name="uq_daily_metrics_asset_timestamp"
        ),
    )
    op.create_index(
        op.f("ix_daily_metrics_asset_id"), "daily_metrics", ["asset_id"], unique=False
    )
    op.create_index(
        op.f("ix_daily_metrics_timestamp"), "daily_metrics", ["timestamp"], unique=False
    )
    op.create_table(
        "price_history",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "asset_id", "timestamp", name="uq_price_history_asset_timestamp"
        ),
    )
    op.create_index(
